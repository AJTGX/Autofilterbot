...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'oTTGArakalTheravadMovies')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), True)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '📂 <em>File Name</em>: <code>AK|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> \n\n❤️‍🔥 </i>Join</i> [ARAKAL THERAVAD MOVIES](https://t.me/ARAKAL_THERAVAD_MOVIES)  \n\n🖥 <i>Requests</i> - ||@ARAKAL_THERAVAD_GROUP_LINKS|| ')
